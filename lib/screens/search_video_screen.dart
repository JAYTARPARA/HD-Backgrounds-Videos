...
class _SearchVideoScreenState extends State<SearchVideoScreen> {
  ...
  void initState() {
    super.initState();
    getVideoBySearch(widget.search.toLowerCase());
  ...
  getVideoBySearch(search) async {
    setState(() {
      loadingRunning = true;
    });
    var videos = await Common().getSearchVideo(search, page);
